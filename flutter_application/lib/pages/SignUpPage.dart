            ...
            [
              ...
              (
                ...
                visible: 
                  showChecksumField,
                child:
                  buildInputTextField(_checksumController, "Code"),
              ),
              // Conditionally hides whatever is inside of it. Used for all text fields. 
              Visibility
              (
                    ...
                    child:
                      ...
                      (
                        ...
                        ()async
                        {
                          ...
                          {
                            case 0:
                              int statcode = await(sendSignUpStart(0, _emailController.text));
                              if(statcode == 200)
                              {
                              ...
                              {
                                errorText = "This email is already registered; please contact \"whatsatcalu@gmail.com\" for more information.";
                                hadError  = true;
                              }
                              else
                              {
                                errorText = "Something went wrong; please try submitting again later.";
                                hadError  = true;
                              }
                              break;
                            ...
                            case 1:
                              int statcode = await(sendSignUpContinue(0, _emailController.text, _checksumController.text));
                              if(statcode == 200)
                              {
                                showEmailField    = false;
                              ...
                              {
                                errorText = "Incorrect code entered; doublecheck the email that was sent to your inbox at \"${_emailController.text.toLowerCase()}@pennwest.edu.\"";
                                hadError  = true;
                              }
                              else
                              {
                            ...
                            case 2:
                              ...
                              int statcode = await(sendSignUpEnd(0, _emailController.text, _passwordController.text));
                              if(statcode == 200)
                              {
                                screenState = 0;
                                hadError    = false;
                                ...
                                setState((){Navigator.of(context).push(MaterialPageRoute(builder: (context) => const MyHomePage()));});
                              }
                              else
                              {
                                errorText = "Something went wrong; please try submitting again later.";

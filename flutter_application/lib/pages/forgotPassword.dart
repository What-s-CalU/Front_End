...
class MyResetPage extends StatefulWidget {
  ...
  @override
  State<MyResetPage> createState() => _MyResetPageState();
}

class _MyResetPageState extends State<MyResetPage> {
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  switch (screenState) {
                    case 0:
                      int statcode =
                          await (sendSignUpStart(1, _emailController.text));
                      if (statcode == 200) {
                        ...
                        errorText =
                            "This email currently is not registered; please contact \"whatsatcalu@gmail.com\" for more information.";
                        hadError = true;
                      } else {
                        errorText =
                    ...
                    case 1:
                      int statcode = await (sendSignUpContinue(
                          1, _emailController.text, _checksumController.text));
                      if (statcode == 200) {
                        showEmailField    = false;
                    ...
                    case 2:
                      ...
                      int statcode = await (sendSignUpEnd(
                          1, _emailController.text, _checksumController.text, _passwordController.text));
                      if (statcode == 200) {
                        screenState = 0;
                        hadError = false;

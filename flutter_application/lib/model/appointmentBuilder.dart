      ...
      child: Column(
        ...
        children: [
          ...
          if (controller.view == CalendarView.month)
            customText('${DateFormat.jm().format(event.startTime)} - ${DateFormat.jm().format(event.endTime)}', 14),
          if (event.description != null && controller.view == CalendarView.day) customText(event.description!, 12)
        ],
      ),
    ),
  );
